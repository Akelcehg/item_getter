jQuery(function ($) {
    ...
    AUTOSTARS.heroflex = function () {
        $('.heroflex').each(function () {
            ...
            var carouselAutoplay = carouselInstance.attr("data-autoplay") == "yes";
            var carouselPagination = carouselInstance.attr("data-pagination") == "yes";
            var carouselArrows = carouselInstance.attr("data-arrows") == "yes";
            var carouselDirection = carouselInstance.attr("data-direction") ? carouselInstance.attr("data-direction") : "horizontal";
            var carouselStyle = carouselInstance.attr("data-style") ? carouselInstance.attr("data-style") : "fade";
            var carouselSpeed = carouselInstance.attr("data-speed") ? carouselInstance.attr("data-speed") : "5000";
            var carouselPause = carouselInstance.attr("data-pause") == "yes";
    ...
    AUTOSTARS.OwlCarousel = function () {
        $('.owl-carousel').each(function () {
            ...
            var carouselPagination = carouselInstance.attr("data-pagination") == 'yes';
            var carouselArrows = carouselInstance.attr("data-arrows") == 'yes';
            var carouselSingle = carouselInstance.attr("data-single-item") == 'yes';
            var carouselStyle = carouselInstance.attr("data-style") ? carouselInstance.attr("data-style") : "fade";
